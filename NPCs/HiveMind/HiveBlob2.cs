...
namespace CalamityMod.NPCs.HiveMind
{
    public class HiveBlob2 : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            float targetX = Main.player[NPC.target].Center.X - (NPC.width / 2) - randomRelocateVector.X;
            float targetY = Main.player[NPC.target].Center.Y - (NPC.height / 2) - randomRelocateVector.Y;
